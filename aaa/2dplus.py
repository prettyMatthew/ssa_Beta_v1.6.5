# ============================================================
# SSA FULL FINAL (3D + 2D MAP) — ALL FEATURES, NO REDUCTION
# ============================================================
# ✅ Fixes included:
...
#   - Next-pass ground track overlay on Earth surface (3D)
#   - ✅ NEW: 2D World Map + Ground Tracks (past/future window) + current subpoints
# ============================================================
...
# =========================
st.set_page_config(page_title="SSA FULL FINAL 3D+2D", layout="wide")
...
st.markdown("## 🛰️ SSA ORBITAL TRACKING CONSOLE — 3D + 2D MAP FULL FINAL")
    ...
    st.markdown(
        ...
        <div class="hud-card hud-mono">
          ...
          <div class="small hud-mono" style="margin-top:8px;">
            LIVE OFF 상태에서는 3D/2D 모두 마우스 조작 시 튕김이 없습니다. LIVE ON은 update 간격으로 갱신됩니다.
          </div>
        </div>
        """,
        unsafe_allow_html=True
